...
Joining the comments I also added a like button so users are able to like their favourite recipes.

In the future I would like to add to the current users profile a list of recipes they have liked that way they can store their favourite recipes and easily come back to them in the future.
